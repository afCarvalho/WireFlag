...
public class AnimationLoader {
	...
	public void loadImages() throws SlickException {
		...
		s_up = new Animation(
				new Image[] { new Image(agent + "grey-back.png") }, duration,
				false);
		s_down = new Animation(
				new Image[] { new Image(agent + "grey-front.png") }, duration,
				false);
		s_left = new Animation(
				new Image[] { new Image(agent + "grey-left.png") }, duration,
				false);
		s_right = new Animation(new Image[] { new Image(agent
				+ "grey-right.png") }, duration, false);
